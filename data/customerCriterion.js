...
// family, student, self-employed, low-income, veteran, pregnant, senior-citizen, in-military, married-no-kids
...
async function createInstrument(name , isin , newusername , newpassword , gender , dob){
    const doctorCollections = await instruments();
    // const hashpassword = await bcrypt.hash(newpassword, saltRounds);
    // deductible, copayment, coinsurance, outOfPocketLimit
    const data = {
        fname: newfname,
        lname: newlname,
        specialism: [],
